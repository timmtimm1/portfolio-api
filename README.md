...
**Cadastro.** A conta já nasce utilizável: você registra e entra na mesma ação.
Não há envio de e-mail no projeto — a confirmação por link existiu e foi removida
quando o deploy mostrou que o plano Free do Render bloqueia as portas SMTP, o que
deixava toda conta nova trancada atrás de um link que nunca chegava.
...
- **Recuperar e trocar senha** — o auth tem registro, login,

...
async def register(
    ...
    """Cadastro com email e senha. A conta ja nasce utilizavel.
    ...
    sempre e mandar a informacao real por e-mail; sem envio de e-mail no projeto,
    essa troca nao esta disponivel, e a mitigacao e o rate limit desta rota. O
    login, esse sim, nao vaza nada.
    """
    try:
